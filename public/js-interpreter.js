...
var ba = "undefined" === typeof globalThis ? this || window : globalThis,
  ca = function (a) {
          ...
          : 65 > f
            ...
            : 91 > f
              ...
              : 97 > f
                ...
                : 123 > f
                  ? !0
                  : 170 <= f && Kc.test(String.fromCharCode(f));
    }
    function d(f) {
      return 65 > f
        ? 36 === f
        : 91 > f
          ...
          : 97 > f
            ...
            : 123 > f
              ? !0
              : 170 <= f && Qb.test(String.fromCharCode(f));
    }
    function c(f, h) {
      var l = r;
      for (var n = 1, w = 0; ; ) {
    ...
    function C() {
      for (; m < oa; ) {
        ...
        if (32 === f) ++m;
          ...
          (++m, (f = r.charCodeAt(m)), 10 === f && ++m, z.D && (++ka, (W = m)));
    ...
    function R(f) {
      switch (f) {
        ...
        case 45:
          h = r.charCodeAt(m + 1);
          h === f
            ? 45 === h && 62 === r.charCodeAt(m + 2) && Wa.test(r.slice(fa, m))
              ? ((m += 3), q(), C(), ha())
              : L(Qc, 2)
            : 61 === h
              ? L(la, 2)
        ...
        case 62:
          ...
          h === f
            ...
            : 33 === h &&
                ...
                45 === r.charCodeAt(m + 3)
              ? ((m += 4), q(), C(), ha())
              : (61 === h && (l = 61 === r.charCodeAt(m + 2) ? 3 : 2),
                L(Tc, l));
          return;
        case 61:
        case 33:
    ...
    function U() {
      ...
      switch (f) {
        ...
        case oc:
          return (
            B(),
            Wa.test(r.slice(fa, I)) && c(fa, "Illegal newline after throw"),
            (h.J = N()),
            ma(),
            y(h, "ThrowStatement")
          );
    ...
    function Ga(f, h) {
      ...
      return E(db)
        ? ((l = ia(f)),
          ...
          (l.fb = !0),
          F(eb),
          Ga(y(l, "MemberExpression"), h))
        : !h && E(X)
          ? ((l = ia(f)),
            (l.callee = f),
            (l.arguments = yb(V, !1)),
            Ga(y(l, "CallExpression"), h))
          : f;
    }
    function ab() {
      switch (x) {
              ...
              for (var O = 0; O < f.h.length; ++O) {
                ...
                if (sa.key.name === n.key.name) {
                  var zb =
                    K === sa.kind ||
                    (w && "init" === sa.kind) ||
                    ("init" === K && ("get" === sa.kind || "set" === sa.kind));
    ...
    a.parse = function (f, h) {
      ...
      l || (f.body = []);
      for (; x !== gb; )
        ((l = U()), f.body.push(l), h && lb(l) && jb(!0), (h = !1));
      return y(f, "Program");
    };
    var zc = {
        ec: !1,
      ...
      Wc = {
        ...
        new: xc,
        in: $a,
        instanceof: { l: "instanceof", K: 7, m: !0 },
        this: tc,
  ...
  do {
    ...
    if (this.wa) break;
      ...
      if (!d || d.time > Date.now()) d = null;
        ...
        d.o &&
          ((c.ma = 2), (c.C = this.Qa), (c.aa = d.o), (c.Ta = !0), (c.G = d.A));
        d = c;
      }
      if (!d) break;
    }
...
p.Wb = function () {
  ...
  var a = this.j;
  return !(a = a[a.length - 1]) || ("Program" === a.node.type && a.done)
    ? (a = this.$[0])
      ? a.time > Date.now()
        ? ua.TASK
        : ua.STEP
...
function Db(a, b) {
  ...
  c = function (e, g, k) {
    ...
    !e.preventExtensions ||
      g in e.h ||
      H(a, a.o, "Can't define property '" + g + "', object is not extensible");
    a.g(e, g, Ka, k.h);
    return e;
  };
  ...
  c = function (e, g) {
    ...
    if (g in e.h) {
      ...
      g = a.s(a.L);
      q || e
        ? (a.g(g, "get", q), a.g(g, "set", e))
        : (a.g(g, "value", k.value), a.g(g, "writable", k.writable));
...
function Eb(a, b) {
  var d = function (c) {
    ...
    if (1 === arguments.length && "number" === typeof g)
      (isNaN(Ra(g)) && H(a, a.$a, "Invalid array length: " + g),
        (e.h.length = g));
    else {
...
function Fb(a, b) {
  ...
  d = function (c, e) {
    ...
    if (2 === a.REGEXP_MODE)
      if (Na)
        ((c = Ec(a, "string.match(regexp)", { string: g, regexp: c }, c, e)),
          c !== La && e(c && Hc(a, c)));
      else {
        var k = a.la(),
          q = Fc(a, c, k, e);
  ...
  d = function (c, e) {
    ...
    if (2 === a.REGEXP_MODE)
      if (Na)
        ((c = Ec(a, "string.search(regexp)", { string: g, regexp: c }, c, e)),
          c !== La && e(c));
      else {
        var k = a.la(),
          q = Fc(a, c, k, e);
...
function Jb(a, b) {
  ...
  d = function (c, e) {
    ...
    if (2 === a.REGEXP_MODE)
      if (Na)
        ((c = Ec(a, "regexp.exec(string)", { string: c, regexp: g }, g, e)),
          c !== La && (a.g(this, "lastIndex", g.lastIndex), e(Hc(a, c))));
      else {
        var k = a.la(),
          q = Fc(a, g, k, e),
          C = this;
...
p.T = function (a, b) {
  ...
  if (P(this, a, this.W))
    return ((a = new Date(a.data.valueOf())), b.ja.push(a), a);
  if (P(this, a, this.V) || P(this, a, this.F) || P(this, a, this.Oa))
    return ((a = Object(a.data)), b.ja.push(a), a);
  d = P(this, a, this.ua) ? [] : {};
  b.ja.push(d);
  for (c in a.h) {
...
function id(a, b, d, c) {
  ...
  a: for (; 0 < e.length; e.pop()) {
    ...
    } else if (2 === b && (c ? g.labels && -1 !== g.labels.indexOf(c) : g.ca))
      return;
  }
  P(a, d, a.A)
    ? ((b = {
...
t.prototype.stepArrayExpression = function (a, b, d) {
  ...
  var c = b.B || 0;
  b.Ra
    ? (this.g(b.Ra, c, b.value), c++)
    : ((b.Ra = Cc(this)), (b.Ra.h.length = d.length));
  for (; c < d.length; ) {
...
t.prototype.stepAssignmentExpression = function (a, b, d) {
  ...
  if (b.ya) (a.pop(), (a[a.length - 1].value = b.kb));
    ...
    if ((d = hd(this, b.Ia, c)))
      return ((b.ya = !0), (b.kb = c), ld(this, d, b.Ia, c));
    a.pop();
  ...
  if (1 === b.ma) {
    ...
    if (Array.isArray(e)) {
      if (
        ...
        return ((b.ma = 1), kd(this, e, b.value));
    } else b.aa = e;
    b.G = [];
    b.B = 0;
  }
...
t.prototype.stepForInStatement = function (a, b, d) {
  if (!b.Rb && ((b.Rb = !0), d.left.ia && d.left.ia[0].za))
    return (
      b.scope.U &&
        H(
          this,
  ...
  if (!b.Fa)
    return ((b.Fa = !0), b.ta || (b.ta = b.value), new u(d.right, b.scope));
      ...
      if (b.v instanceof D)
        for (b.Ba || (b.Ba = Object.getOwnPropertyNames(b.v.h)); ; ) {
          ...
          if (
            ...
            !b.mb[c] &&
            ((b.mb[c] = !0),
            Object.prototype.propertyIsEnumerable.call(b.v.h, c))
          ) {
            b.Ua = c;
            break a;
          }
  ...
  b.ta || (b.ta = b.value);
  if (!b.ya && ((b.ya = !0), (a = b.Ua), (c = hd(this, b.ta, a))))
    return ld(this, c, b.ta, a);
  b.Ua = void 0;
  b.wb = !1;
  b.ya = !1;
      ...
      if (e || b.Ka || -1 === b.gb)
        if (e) {
          ...
          if (b.Ka || b.value === b.fc) {
            ...
            var g = b.B || 0;
            if (e.fa[g])
              return ((b.Xb = !0), (b.B = g + 1), new u(e.fa[g], b.scope));
          }
          b.Db = !1;
          b.B = 0;
          b.jb = c + 1;
...
t.prototype.stepTryStatement = function (a, b, d) {
  ...
  if (b.ha && 4 === b.ha.type && !b.Qb && d.Ha)
    return (
      (b.Qb = !0),
      (a = dd(this, b.scope)),
      this.g(a.object, d.Ha.Wa.name, b.ha.value),
      (b.ha = void 0),
      new u(d.Ha.body, a)
    );
...
t.prototype.stepUpdateExpression = function (a, b, d) {
  ...
  if (b.ya) (a.pop(), (a[a.length - 1].value = b.kb));
    ...
    d = d.prefix ? e : c;
    if ((c = hd(this, b.Ja, e)))
      return ((b.ya = !0), (b.kb = d), ld(this, c, b.Ja, e));
    a.pop();
    a[a.length - 1].value = d;
  }
};
t.prototype.stepVariableDeclaration = function (a, b, d) {
  ...
  for (; e; ) {
    if (e.za)
      return ((b.B = c), (b.Ab = !0), (b.Sa = e.id.name), new u(e.za, b.scope));
    e = d[++c];
  }
  a.pop();
};
