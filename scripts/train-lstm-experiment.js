...
if (data.feature_schema && data.feature_schema !== '10f') throw Error('Use npm run model for the new recent-feature dataset; this script is the legacy experiment runner.');
